...
mysql_select_db($database_liaisondb, $liaisondb);
$query_rsNumVols = "SELECT * FROM numero_vol ORDER BY numero_vol.id DESC";
     ...
     <input name="Minuitevol" type="text" required class="span1" id="minute" />
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            ...
                                            <button type="submit" id="Submit" name="SubmitSuiv" class="btn btn-primary"></span> Suivant  <i class="icon-arrow-right icon-white"></i></button>
                                        </div>
                                    </div>
                                </form>
