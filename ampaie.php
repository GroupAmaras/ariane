...
<div class="control-group" align="center" style="margin-top:40px;">
    <div class="controls">
      ...
      <button type="button" name="return" id="return" class="btn btn-danger" onclick="window.location.replace('infovols.php');"><i class="icon-circle-arrow-left icon-white"></i> Retour</button>
