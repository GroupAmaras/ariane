      ...
      <div style="margin-bottom:10px;">
        ...
        <div class="pull-right" style="margin-bottom:20px;">
          Total opérations en cours:  <strong><?php echo $totalRows_rsOperations ?></strong>
           ...
           <table data-toggle="table" class="table table-striped table-hover" width="100%" border="0" cellspacing="1" cellpadding="2" data-cache="false" >
                  <thead>
                  <tr>
                    <th width="25%">Date</th>
                    <th>Service</th>
              ...
              <?php do { ?>
                  <tr>
                    <td width="25%">
                      <?php LongDateEN2dateFR($row_rsOperations['date_creation']); ?>
                    </td>
