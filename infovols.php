...
<div class="control-group">
  ...
  <div class="control-group">
    ...
    <div class="control-group">
        <label class="control-label" for="vol">Heure du vol</label>
        <div class="controls">
            <input name="Heurevol" type="text" readonly class="input-large" id="vol" value="<?= trim($_SESSION['Heurevol']).' h '.trim($_SESSION['Minuitevol']).' min'; ?>">
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <div class="input-append">
                <input type="text" id="cout" name="montant" class="input-small" style="text-align:right;color:red;" value="1000" readonly="readonly">
